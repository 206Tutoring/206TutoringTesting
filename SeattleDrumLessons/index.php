<?php
session_start();
$_SESSION['myValue']="Seattle Drum Lessons";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Seattle Drum Lessons</title>
        ...
        <div>
            <div class="col-md-4">
              <div class="video-container">
                ...
                src="https://www.youtube.com/embed/rd_THC-9MgM">
                </iframe>
              </div>
            </div>
            <div class="col-md-4">
              <h1>SEATTLE DRUM LESSONS</h1>
              <h6>206 Music Lessons is happy to offer <b>drum lessons.</b> If you’re interested in starting on the drums from scratch, or already have some experience and want to pick up new techniques and styles, we have the right instructor for you.</h6>
              <h6>We pride ourselves on hiring only the most skilled and dedicated music-education professionals, and matching students to someone aligned with their interests, aspirations, and ability level. Our instructors’ training runs the gamut from <b>classical</b> to <b>rock,</b> from <b>jazz</b> to <b>pop. Movie music</b> and <b>video-game music</b> are particular specialties.</h6>
              <h6><b>Our drum lessons are fun,</b> with a light-hearted approach puts you in in a better mindset to learn. All students of all ages and all levels of experience are welcome.</h6>
