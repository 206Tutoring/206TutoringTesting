    ...
    <!-- Page Content -->
        <div>
            ...
            <div class="col-md-4">
              ...
              <br>
              <p>At 206 Tutoring, we believe that <b>every student deserves to understand geometry.</b> Geometry is a useful tool beyond middle-school math and high-school math, to college and the adult job market and beyond. Geometry shouldn’t be a cause for anxiety and frustration, but <b>confidence and discovery.</b></p>
              <br>
              <p>Our tutors have years of experience teaching geometry; geometry classes are among our most popular offerings. Several of us were mathletes in middle school, were two to three years ahead in math in high school, and earned math degrees as undergrads or grad students. We earned <b>4’s and 5’s</b> on the <b>Calculus AB, Calculus BC,</b> and <b>Statistics AP tests.</b> Our SAT math scores range from <b>750 to 800.</b></p>
              <br>
              <p>Every math class could be aced by a majority of students. Our teaching reflects this belief. Our <b>individualized lessons</b> adapt to each student’s learning style. There may only be one right answer, but there are countless ways to get that answer. Approached from the right perspective, geometry is just as learnable as the math subjects that came before it.</p>
            </div>
            <!-- /.col-md-4 -->
            <div class="col-md-4">
              <br>
