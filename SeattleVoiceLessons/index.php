<?php
session_start();
$_SESSION['myValue']="Seattle Voice Lessons";
?>
...
<body>
    ...
    <!-- Page Content -->
        <div>
            <div class="col-md-4">
              <img src="../SeattleVoiceLessons/seattlevoicelessons.png" class="img-responsive" alt="Responsive image">
            </div>
            <div class="col-md-4">
              <h1>SEATTLE VOICE LESSONS</h1>
              <h6>206 Music Lessons is happy to offer <b>voice lessons.</b> If you’re interested in learning how to sing from scratch, or already have some experience and want to pick up new techniques and styles, we have the right instructor for you.</h6>
              <h6>We pride ourselves on hiring only the most skilled and dedicated music-education professionals, and matching students to someone aligned with their interests, aspirations, and ability level. Our instructors’ training runs the gamut from <b>classical</b> to <b>rock,</b> from <b>jazz</b> to <b>pop</b> to <b>musical theatre, opera,</b> and <b>more.</b></h6>
              <h6><b>Our voice lessons are fun,</b> with a light-hearted approach puts you in in a better mindset to learn. All students of all ages and all levels of experience are welcome.</h6>
