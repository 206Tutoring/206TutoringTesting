...
<html lang="en">
<head>
  <title>206 Tutoring - Seattle Middle School Math Tutoring</title>
  <meta charset="utf-8">
...
<div class="main-content">
	<h1 class="top-header">SEATTLE'S BEST MIDDLE-SCHOOL MATH TUTORS</h1>
	
  	<div class="row">
	  
      <div class="landing-content col-md-4 col-sm-6">
        <p>206 Tutoring offers individualized, results-focused math instruction with the greatest improvements in the Seattle area. <strong>We specialize in teaching middle-school math, including Pre-Algebra, Algebra I, Geometry, Algebra II, Pre-Calculus, Integrated math, Common Core, and more.</strong>. Raise your test scores by <strong>one full letter grade</strong>.
</p>
