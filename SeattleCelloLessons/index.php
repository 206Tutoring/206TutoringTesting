<?php
session_start();
$_SESSION['myValue']="Seattle Cello Lessons";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Seattle Cello Lessons</title>
...
<body>
    ...
    <!-- Page Content -->
        <div>
            <div class="col-md-4">
              <img src="../SeattleCelloLessons/seattlecellolessons.png" class="img-responsive" alt="Responsive image">
            </div>
            <div class="col-md-4">
              <h1>SEATTLE CELLO LESSONS</h1>
              <h6>206 Music Lessons is happy to offer <b>cello lessons.</b> If you’re interested in starting the cello from scratch, or already have some experience and want to pick up new techniques and styles, we have the right instructor for you.</h6>
              <h6>We pride ourselves on hiring only the most skilled and dedicated music-education professionals, and matching students to someone aligned with their interests, aspirations, and ability level. <b>The cello is still the coolest instrument across all genres!</b> Our instructors’ training runs the gamut from <b>classical</b> to <b>rock,</b> from <b>jazz</b> to <b>pop,</b> from <b>solo</b> to <b>orchestral. Movie music</b> and <b>video-game music</b> are particular specialties.</h6>
              <h6><b>Our cello lessons are fun,</b> with a light-hearted approach that puts you in in a better mindset to learn. All students of all ages and all levels of experience are welcome.</h6>
