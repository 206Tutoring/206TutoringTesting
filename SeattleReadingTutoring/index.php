...
<html lang="en">
<head>
  <title>206 Tutoring - Seattle Reading Tutoring</title>
  <meta charset="utf-8">
...
<div class="main-content">
	<h1 class="top-header">SEATTLE'S BEST READING TUTORS</h1>
	
  	<div class="row">
	  
      <div class="landing-content col-md-4 col-sm-6">
        <p>206 Tutoring offers elite, individualized reading instruction experienced tutors at the location of your choice. Take advantage of our full range of services, from learning to read in<strong>elementary school</strong>, to interpreting difficult literature in <strong>high school</strong>, getting ideas from dense textbooks in <strong>college</strong>, and beyond.
</p>
