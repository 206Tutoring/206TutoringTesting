...
<html lang="en">
<head>
  <title>206 Tutoring - Seattle Alegebra Tutoring</title>
  <meta charset="utf-8">
...
<div class="main-content">
	<h1 class="top-header">SEATTLE'S BEST ALGEBRA TUTORS</h1>
	
  	<div class="row">
	  
      <div class="landing-content col-md-4 col-sm-6">
        <p>206 Tutoring offers individualized, results-focused Algebra I and Algebra II instruction with the greatest improvements in the Seattle area. Raise your test scores by <strong>one full letter grade</strong>.
</p>

<p>We earned <strong>4’s or 5’s</strong> on the <strong>math AP tests</strong>. Our SAT math scores range from <strong>700 to 800</strong>.</p>
