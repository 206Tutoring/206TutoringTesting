<?php
session_start();
$_SESSION['myValue']="Seattle Algebra Tutoring";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Seattle Algebra Tutoring</title>
...
<body>
    ...
    <!-- Page Content -->
        <div>
            <div class="col-md-4">
              <img src="../SeattleAlgebraTutoring/seattlealgebratutoring.png" class="img-responsive" alt="Responsive image">
            </div>
            <div class="col-md-4">
              <h1>SEATTLE ALGEBRA TUTORING</h1>
              <h6>At 206 Tutoring, we believe that <b>every student deserves to understand algebra.</b> Algebra is a useful tool beyond middle-school math and high-school math, to college and the adult job market and beyond. Algebra shouldn’t be a cause for anxiety and frustration, but <b>confidence and discovery.</b></h6>
              <h6>Our tutors have years of experience teaching Algebra I and Algebra II; both classes are among our most popular offerings. Several of us were mathletes in middle school, were two to three years ahead in math in high school, and earned math degrees as undergrads or grad students. We earned <b>4’s and 5’s</b> on the <b>Calculus AB, Calculus BC,</b> and <b>Statistics AP tests.</b> Our SAT math scores range from <b>750 to 800.</b></h6>
              <h6>Every math class could be aced by a majority of students. Our teaching reflects this belief. Our <b>individualized lessons</b> adapt to each student’s learning style. There may only be one right answer, but there are countless ways to get that answer. Approached from the right perspective, algebra is just as learnable as the subjects that came before it.</h6>
            </div>
            <!-- /.col-md-4 -->
            <div class="col-md-4">
